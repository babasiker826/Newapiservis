...
# YENİ API LİSTESİ - Nabi API
ALL_APIS = [
    # 🔹 YABANCI SORGULARI
    {"id": "yabanci", "title": "YABANCI SORGULAMA", "icon": "🌍",
     "url": "https://nabi-api.trr.gt.tc/yabanci?ad=JOHN&soyad=DOE", "desc": "Yabancı ad soyad sorgulama."},

    # 🔹 TC DETAY SORGULARI
    {"id": "cinsiyet", "title": "CİNSİYET SORGULAMA", "icon": "⚧️",
     "url": "https://nabi-api.trr.gt.tc/cinsiyet?tc=11111111111", "desc": "TC ile cinsiyet sorgulama."},
    {"id": "din", "title": "DİN SORGULAMA", "icon": "🕌",
     "url": "https://nabi-api.trr.gt.tc/din?tc=11111111111", "desc": "TC ile din bilgisi sorgulama."},
    {"id": "vergino_tc", "title": "VERGİ NO SORGULAMA", "icon": "💰",
     "url": "https://nabi-api.trr.gt.tc/vergino?tc=11111111111", "desc": "TC ile vergi numarası sorgulama."},
    {"id": "medenihal", "title": "MEDENİ HAL SORGULAMA", "icon": "💍",
     "url": "https://nabi-api.trr.gt.tc/medenihal?tc=11111111111", "desc": "TC ile medeni hal sorgulama."},
    {"id": "koy", "title": "KÖY SORGULAMA", "icon": "🏞️",
     "url": "https://nabi-api.trr.gt.tc/koy?tc=11111111111", "desc": "TC ile köy bilgisi sorgulama."},
    {"id": "burc", "title": "BURÇ SORGULAMA", "icon": "♈",
     "url": "https://nabi-api.trr.gt.tc/burc?tc=11111111111", "desc": "TC ile burç sorgulama."},
    {"id": "kimlikkayit", "title": "KİMLİK KAYIT SORGULAMA", "icon": "📋",
     "url": "https://nabi-api.trr.gt.tc/kimlikkayit?tc=11111111111", "desc": "TC ile kimlik kayıt sorgulama."},
    {"id": "dogumyeri", "title": "DOĞUM YERİ SORGULAMA", "icon": "🏥",
     "url": "https://nabi-api.trr.gt.tc/dogumyeri?tc=11111111111", "desc": "TC ile doğum yeri sorgulama."},

    # 🔹 YETİMLİK SORGUSU
    {"id": "yetimlik", "title": "YETİMLİK SORGULAMA", "icon": "👨‍👧‍👦",
     "url": "https://nabi-api.trr.gt.tc/yetimlik?babatc=11111111111", "desc": "Baba TC ile yetimlik sorgulama."},

    # 🔹 AİLE SORGULARI
    {"id": "kardes", "title": "KARDEŞ SORGULAMA", "icon": "👥",
     "url": "https://nabi-api.trr.gt.tc/kardes?tc=11111111111", "desc": "TC ile kardeş bilgisi sorgulama."},
    {"id": "anne", "title": "ANNE SORGULAMA", "icon": "👩",
     "url": "https://nabi-api.trr.gt.tc/anne?tc=11111111111", "desc": "TC ile anne bilgisi sorgulama."},
    {"id": "baba", "title": "BABA SORGULAMA", "icon": "👨",
     "url": "https://nabi-api.trr.gt.tc/baba?tc=11111111111", "desc": "TC ile baba bilgisi sorgulama."},
    {"id": "cocuklar", "title": "ÇOCUKLAR SORGULAMA", "icon": "👶",
     "url": "https://nabi-api.trr.gt.tc/cocuklar?tc=11111111111", "desc": "TC ile çocuk bilgisi sorgulama."},
    {"id": "amca", "title": "AMCA SORGULAMA", "icon": "👨‍🦳",
     "url": "https://nabi-api.trr.gt.tc/amca?tc=11111111111", "desc": "TC ile amca bilgisi sorgulama."},
    {"id": "dayi", "title": "DAYI SORGULAMA", "icon": "👨‍🦱",
     "url": "https://nabi-api.trr.gt.tc/dayi?tc=11111111111", "desc": "TC ile dayı bilgisi sorgulama."},
    {"id": "hala", "title": "HALA SORGULAMA", "icon": "👩‍🦳",
     "url": "https://nabi-api.trr.gt.tc/hala?tc=11111111111", "desc": "TC ile hala bilgisi sorgulama."},
    {"id": "teyze", "title": "TEYZE SORGULAMA", "icon": "👩‍🦱",
     "url": "https://nabi-api.trr.gt.tc/teyze?tc=11111111111", "desc": "TC ile teyze bilgisi sorgulama."},
    {"id": "kuzen", "title": "KUZEN SORGULAMA", "icon": "🧑‍🤝‍🧑",
     "url": "https://nabi-api.trr.gt.tc/kuzen?tc=11111111111", "desc": "TC ile kuzen bilgisi sorgulama."},
    {"id": "dede", "title": "DEDE SORGULAMA", "icon": "👴",
     "url": "https://nabi-api.trr.gt.tc/dede?tc=11111111111", "desc": "TC ile dede bilgisi sorgulama."},
    {"id": "nine", "title": "NİNE SORGULAMA", "icon": "👵",
     "url": "https://nabi-api.trr.gt.tc/nine?tc=11111111111", "desc": "TC ile nine bilgisi sorgulama."},
    {"id": "yeniden", "title": "YENİDEN SORGULAMA", "icon": "🔄",
     "url": "https://nabi-api.trr.gt.tc/yeniden?tc=11111111111", "desc": "TC ile yeniden sorgulama."},

    # 🔹 SAHMARAN BOTU SORGULARI
    {"id": "sorgu", "title": "AD SOYAD SORGULAMA", "icon": "🔍",
     "url": "https://nabi-api.trr.gt.tc/sorgu?ad=AHMET&soyad=YILMAZ", "desc": "Ad soyad ile kişi sorgulama."},
    {"id": "aile_sahmaran", "title": "AILE SORGULAMA", "icon": "🏠",
     "url": "https://nabi-api.trr.gt.tc/aile?tc=11111111111", "desc": "TC ile aile bilgisi sorgulama."},
    {"id": "adres_sahmaran", "title": "ADRES SORGULAMA", "icon": "📍",
     "url": "https://nabi-api.trr.gt.tc/adres?tc=11111111111", "desc": "TC ile adres sorgulama."},
    {"id": "tc_sahmaran", "title": "TC SORGULAMA", "icon": "🆔",
     "url": "https://nabi-api.trr.gt.tc/tc?tc=11111111111", "desc": "TC kimlik sorgulama."},
    {"id": "gsmtc", "title": "GSM TC SORGULAMA", "icon": "📱",
     "url": "https://nabi-api.trr.gt.tc/gsmtc?gsm=5551112233", "desc": "GSM numarası ile TC sorgulama."},
    {"id": "tcgsm", "title": "TC GSM SORGULAMA", "icon": "📞",
     "url": "https://nabi-api.trr.gt.tc/tcgsm?tc=11111111111", "desc": "TC ile GSM numarası sorgulama."},
    {"id": "olumtarihi", "title": "ÖLÜM TARİHİ SORGULAMA", "icon": "⚰️",
     "url": "https://nabi-api.trr.gt.tc/olumtarihi?tc=11111111111", "desc": "TC ile ölüm tarihi sorgulama."},
    {"id": "sulale", "title": "SÜLALE SORGULAMA", "icon": "🌳",
     "url": "https://nabi-api.trr.gt.tc/sulale?tc=11111111111", "desc": "TC ile sülale sorgulama."},
    {"id": "sms", "title": "SMS SORGULAMA", "icon": "💬",
     "url": "https://nabi-api.trr.gt.tc/sms?gsm=5551112233", "desc": "GSM ile SMS sorgulama."},
    {"id": "kizliksoyad", "title": "KIZLIK SOYADI SORGULAMA", "icon": "👰",
     "url": "https://nabi-api.trr.gt.tc/kizliksoyad?tc=11111111111", "desc": "TC ile kızlık soyadı sorgulama."},
    {"id": "yas_sahmaran", "title": "YAŞ SORGULAMA", "icon": "🎂",
     "url": "https://nabi-api.trr.gt.tc/yas?tc=11111111111", "desc": "TC ile yaş sorgulama."},
    {"id": "hikaye", "title": "HAYAT HİKAYESİ SORGULAMA", "icon": "📖",
     "url": "https://nabi-api.trr.gt.tc/hikaye?tc=11111111111", "desc": "TC ile hayat hikayesi sorgulama."},
    {"id": "sirano", "title": "SIRA NO SORGULAMA", "icon": "🔢",
     "url": "https://nabi-api.trr.gt.tc/sirano?tc=11111111111", "desc": "TC ile sıra no sorgulama."},
    {"id": "ayakno", "title": "AYAK NO SORGULAMA", "icon": "👣",
     "url": "https://nabi-api.trr.gt.tc/ayakno?tc=11111111111", "desc": "TC ile ayak no sorgulama."},
    {"id": "operator", "title": "OPERATÖR SORGULAMA", "icon": "📶",
     "url": "https://nabi-api.trr.gt.tc/operator?gsm=5551112233", "desc": "GSM ile operatör sorgulama."},
    {"id": "yegen", "title": "YEĞEN SORGULAMA", "icon": "🧒",
     "url": "https://nabi-api.trr.gt.tc/yegen?tc=11111111111", "desc": "TC ile yeğen bilgisi sorgulama."},
    {"id": "cocuk", "title": "ÇOCUK SORGULAMA", "icon": "👧",
     "url": "https://nabi-api.trr.gt.tc/cocuk?tc=11111111111", "desc": "TC ile çocuk bilgisi sorgulama."},

    # 🔹 MİYAVREM BOTU SORGULARI
    {"id": "vesika", "title": "VESİKA SORGULAMA", "icon": "🪪",
     "url": "https://nabi-api.trr.gt.tc/vesika?tc=11111111111", "desc": "TC ile vesika sorgulama."},
    {"id": "plaka", "title": "PLAKA SORGULAMA", "icon": "🚗",
     "url": "https://nabi-api.trr.gt.tc/plaka?plaka=34ABC123", "desc": "Plaka ile araç sorgulama."},
    {"id": "tcplaka", "title": "TC PLAKA SORGULAMA", "icon": "🚙",
     "url": "https://nabi-api.trr.gt.tc/tcplaka?tc=11111111111", "desc": "TC ile plaka sorgulama."}
]

# HTML template (Güvenlik header'ları eklendi)
...
<title>Nabi System API Servisi — v3</title>
...
<div class="wrapper">
  <header>
    <div class="header-top">
      <div>
        <h1>Nabi System</h1>
        <div style="color:var(--muted);font-size:13px">API Service • Secure • Mobile Uyumlu</div>
      </div>
      <div class="controls">
  ...
  <main>
    <div style="background:linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.01));padding:10px;border-radius:10px;border:1px solid rgba(255,255,255,0.04);color:var(--muted);margin-bottom:12px">
      ...
      <strong>Güvenlik Uyarısı:</strong> Apiler bize aittir. Lütfen verileri paylaşırken gizlilik ve yasalara dikkat ediniz.
    </div>

    <h2 style="color:var(--accent-1);margin-bottom:8px">🚀 NABI API LİSTESİ ({{ total }} API)</h2>
  ...
  <footer style="margin-top:20px;text-align:center;color:var(--muted);font-size:12px">
    NABI SYSTEM SUNAR — v3 • {{ total }} API • Secure • Mobile Uyumlu<br>© 2025 Nabi System • Telegram: @sukazatkinis
  </footer>
</div>
...
# Routes
@app.route("/")
@rate_limit(requests_per_minute=30)  # Ana sayfa için rate limiting
def home():
    return render_template_string(HTML_TEMPLATE, apis=ALL_APIS, total=len(ALL_APIS))

@app.route("/api-list")
@rate_limit(requests_per_minute=10)  # API listesi için daha sıkı rate limiting
def api_list():
